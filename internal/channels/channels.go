...
var (
	...
	ErrProviderCredentialCipherRequired = errors.New("provider credential cipher is required")
	ErrProviderCredentialKeyInvalid     = errors.New("provider credential encryption key is invalid")
	ErrProviderCredentialEncryptFailed  = errors.New("provider credential encryption failed")
	ErrProviderCredentialDecryptFailed  = errors.New("provider credential decryption failed")
)
