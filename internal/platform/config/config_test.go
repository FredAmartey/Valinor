...
func TestLoad_ChannelsEnvOverrides(t *testing.T) {
	os.Setenv("HEIMDALL_CHANNELS_INGRESS_ENABLED", "true")
	os.Setenv("HEIMDALL_CHANNELS_CREDENTIALS_KEY", "MDEyMzQ1Njc4OWFiY2RlZjAxMjM0NTY3ODlhYmNkZWY=")
	os.Setenv("HEIMDALL_CHANNELS_INGRESS_RETENTIONCLEANUPENABLED", "false")
	os.Setenv("HEIMDALL_CHANNELS_INGRESS_RETENTIONCLEANUPINTERVALSECONDS", "1800")
	os.Setenv("HEIMDALL_CHANNELS_INGRESS_RETENTIONCLEANUPBATCHSIZE", "333")
	os.Setenv("HEIMDALL_CHANNELS_INGRESS_TENANTSCANPAGESIZE", "777")
	os.Setenv("HEIMDALL_CHANNELS_PROVIDERS_SLACK_ENABLED", "true")
	os.Setenv("HEIMDALL_CHANNELS_PROVIDERS_SLACK_APIBASEURL", "https://slack.test")
	os.Setenv("HEIMDALL_CHANNELS_PROVIDERS_SLACK_ACCESSTOKEN", "xoxb-slack-token")
	os.Setenv("HEIMDALL_CHANNELS_PROVIDERS_WHATSAPP_ENABLED", "true")
	os.Setenv("HEIMDALL_CHANNELS_PROVIDERS_WHATSAPP_SIGNINGSECRET", "wa-secret")
	os.Setenv("HEIMDALL_CHANNELS_PROVIDERS_WHATSAPP_APIBASEURL", "https://graph.test")
	os.Setenv("HEIMDALL_CHANNELS_PROVIDERS_WHATSAPP_APIVERSION", "v99.0")
	os.Setenv("HEIMDALL_CHANNELS_PROVIDERS_WHATSAPP_ACCESSTOKEN", "wa-access-token")
	os.Setenv("HEIMDALL_CHANNELS_PROVIDERS_WHATSAPP_PHONENUMBERID", "123456789")
	os.Setenv("HEIMDALL_CHANNELS_PROVIDERS_TELEGRAM_ENABLED", "true")
	os.Setenv("HEIMDALL_CHANNELS_PROVIDERS_TELEGRAM_APIBASEURL", "https://telegram.test")
	os.Setenv("HEIMDALL_CHANNELS_PROVIDERS_TELEGRAM_ACCESSTOKEN", "123456:ABCDEF")
	defer func() {
		os.Unsetenv("HEIMDALL_CHANNELS_INGRESS_ENABLED")
		os.Unsetenv("HEIMDALL_CHANNELS_CREDENTIALS_KEY")
		os.Unsetenv("HEIMDALL_CHANNELS_INGRESS_RETENTIONCLEANUPENABLED")
		os.Unsetenv("HEIMDALL_CHANNELS_INGRESS_RETENTIONCLEANUPINTERVALSECONDS")
		os.Unsetenv("HEIMDALL_CHANNELS_INGRESS_RETENTIONCLEANUPBATCHSIZE")
		os.Unsetenv("HEIMDALL_CHANNELS_INGRESS_TENANTSCANPAGESIZE")
		os.Unsetenv("HEIMDALL_CHANNELS_PROVIDERS_SLACK_ENABLED")
		os.Unsetenv("HEIMDALL_CHANNELS_PROVIDERS_SLACK_APIBASEURL")
		os.Unsetenv("HEIMDALL_CHANNELS_PROVIDERS_SLACK_ACCESSTOKEN")
		os.Unsetenv("HEIMDALL_CHANNELS_PROVIDERS_WHATSAPP_ENABLED")
		os.Unsetenv("HEIMDALL_CHANNELS_PROVIDERS_WHATSAPP_SIGNINGSECRET")
		os.Unsetenv("HEIMDALL_CHANNELS_PROVIDERS_WHATSAPP_APIBASEURL")
		os.Unsetenv("HEIMDALL_CHANNELS_PROVIDERS_WHATSAPP_APIVERSION")
		os.Unsetenv("HEIMDALL_CHANNELS_PROVIDERS_WHATSAPP_ACCESSTOKEN")
		os.Unsetenv("HEIMDALL_CHANNELS_PROVIDERS_WHATSAPP_PHONENUMBERID")
		os.Unsetenv("HEIMDALL_CHANNELS_PROVIDERS_TELEGRAM_ENABLED")
		os.Unsetenv("HEIMDALL_CHANNELS_PROVIDERS_TELEGRAM_APIBASEURL")
		os.Unsetenv("HEIMDALL_CHANNELS_PROVIDERS_TELEGRAM_ACCESSTOKEN")
	}()
...
func TestLoad_ChannelsOutboxEnvOverrides(t *testing.T) {
	os.Setenv("HEIMDALL_CHANNELS_OUTBOX_ENABLED", "false")
	os.Setenv("HEIMDALL_CHANNELS_OUTBOX_POLLINTERVALSECONDS", "9")
	os.Setenv("HEIMDALL_CHANNELS_OUTBOX_CLAIMBATCHSIZE", "17")
	os.Setenv("HEIMDALL_CHANNELS_OUTBOX_RECOVERYBATCHSIZE", "13")
	os.Setenv("HEIMDALL_CHANNELS_OUTBOX_LOCKTIMEOUTSECONDS", "44")
	os.Setenv("HEIMDALL_CHANNELS_OUTBOX_MAXATTEMPTS", "8")
	os.Setenv("HEIMDALL_CHANNELS_OUTBOX_BASERETRYSECONDS", "7")
	os.Setenv("HEIMDALL_CHANNELS_OUTBOX_MAXRETRYSECONDS", "180")
	os.Setenv("HEIMDALL_CHANNELS_OUTBOX_JITTERFRACTION", "0.35")
	os.Setenv("HEIMDALL_CHANNELS_OUTBOX_TENANTSCANPAGESIZE", "444")
	defer func() {
		os.Unsetenv("HEIMDALL_CHANNELS_OUTBOX_ENABLED")
		os.Unsetenv("HEIMDALL_CHANNELS_OUTBOX_POLLINTERVALSECONDS")
		os.Unsetenv("HEIMDALL_CHANNELS_OUTBOX_CLAIMBATCHSIZE")
		os.Unsetenv("HEIMDALL_CHANNELS_OUTBOX_RECOVERYBATCHSIZE")
		os.Unsetenv("HEIMDALL_CHANNELS_OUTBOX_LOCKTIMEOUTSECONDS")
		os.Unsetenv("HEIMDALL_CHANNELS_OUTBOX_MAXATTEMPTS")
		os.Unsetenv("HEIMDALL_CHANNELS_OUTBOX_BASERETRYSECONDS")
		os.Unsetenv("HEIMDALL_CHANNELS_OUTBOX_MAXRETRYSECONDS")
		os.Unsetenv("HEIMDALL_CHANNELS_OUTBOX_JITTERFRACTION")
		os.Unsetenv("HEIMDALL_CHANNELS_OUTBOX_TENANTSCANPAGESIZE")
	}()
