    ...
    <div className="space-y-8">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex gap-2">
          <span
            title={
              !canWrite ? "You don't have permission to do this." : undefined
            }
      ...
      <div className="flex flex-wrap gap-6 border-t border-zinc-200 pt-4 text-sm">
        <div>
          ...
          <p className="font-mono text-zinc-900">
            {formatTimeAgo(agent.last_health_check)}
          </p>
        </div>
        <div>
      ...
      <div className="flex flex-wrap gap-6 text-sm">
        ...
        {agent.department_id && (
          <div>
            ...
            <p>
              <Link
                href={`/departments/${agent.department_id}`}
                className="font-mono text-zinc-900 hover:underline"
              >
      ...
      {/* Agent activity is visible to readers with agent access. */}
      <AgentActivityTimeline agentId={id} />
